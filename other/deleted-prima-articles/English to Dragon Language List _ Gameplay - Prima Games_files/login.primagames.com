...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://web.archive.org/web/20151231175836/https://login.primagames.com";
...
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://web.archive.org/web/20151231175836/https://login.primagames.com";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://web.archive.org/web/20151231175836/https://login.primagames.com";
...
function getRootPath() {
    if (window.localStorage && localStorage.janrainLocalWidgetCodeEnabled === "true") {
        var rootPath = localStorage.janrainLocalWidgetCodeUrl || "https://web.archive.org/web/20151231175836/http://apps.janrain.com:4567/";
    } else if (janrain.settings.enforceSecureCloudfront) {
        var rootPath = "https://web.archive.org/web/20151231175836/https://ssl-widget-cdn.rpxnow.com/";
    } else {
        var rootPath = document.location.protocol === 'https:' ? "https://web.archive.org/web/20151231175836/https://d29usylhdk1xyu.cloudfront.net/" : "https://web.archive.org/web/20151231175836/http://widget-cdn.rpxnow.com/";
    }
    return rootPath;
}
...
/*
     FILE ARCHIVED ON 17:58:36 Dec 31, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:29:14 Dec 14, 2024.
...
playback timings (ms):
  ...
  PetaboxLoader3.datanode: 132.464 (5)
  PetaboxLoader3.resolve: 176.417 (4)
  load_resource: 241.738 (2)
*/