...
function startLogin(providerbutton) {
  ...
  switch (provider) {
    case 'aol':
      ...
      oidbase = 'https://web.archive.org/web/20140322235841/https://openid.aol.com/{screenname}';
      getoidpart = 'true';
      break;
    case 'blogger':
      action = 'https://'+realm+'/openid/start';
    ...
    case 'facebook':
      ...
      extra = '<input type="hidden" name="ext_perm" value="publish_stream,email" /><input type="hidden" name="redirect_to" value="https://web.archive.org/web/20140322235841/http://prima.mediaclash.co.uk/games/" />';
      break;
    case 'flickr':
      action = 'https://'+realm+'/openid/start';
      oidbase = 'https://web.archive.org/web/20140322235841/http://me.yahoo.com/';
      break;
    case 'foursquare':
    ...
    case 'google':
      action = 'https://'+realm+'/openid/start';
      oidbase = 'https://web.archive.org/web/20140322235841/https://www.google.com/accounts/o8/id';
      break;
    case 'hyves':
      action = 'https://'+realm+'/openid/start';
      oidbase = 'https://web.archive.org/web/20140322235841/http://hyves.nl/';
      break;
    case 'linkedin':
    ...
    case 'myopenid':
      action = 'https://'+realm+'/openid/start';
      oidbase = 'https://web.archive.org/web/20140322235841/http://myopenid.com/';
      break;
    case 'myspace':
    ...
    case 'netlog':
      action = 'https://'+realm+'/openid/start';
      oidbase = 'https://web.archive.org/web/20140322235841/http://netlog.com/{nickname}';
      getoidpart = 'true';
      break;
    case 'openid':
      action = 'https://'+realm+'/openid/start';
    ...
    case 'paypal':
      action = 'https://'+realm+'/openid/start';
      oidbase = 'https://web.archive.org/web/20140322235841/https://openid.paypal-ids.com/';
      break;
    case 'salesforce':
    ...
    case 'symantec':
      action = 'https://'+realm+'/openid/start';
      oidbase = 'https://web.archive.org/web/20140322235841/http://pip.verisignlabs.com/';
      break;
    case 'vzn':
...
playback timings (ms):
  ...
  esindex: 0.013
  cdx.remote: 21.022
  LoadShardBlock: 66.419 (3)
  PetaboxLoader3.datanode: 89.212 (5)
  load_resource: 165.622 (2)
  PetaboxLoader3.resolve: 104.295 (2)
*/