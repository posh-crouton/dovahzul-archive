...
function GetEsoSkillTooltipHtml(skillData)
{
	...
	output += "<img src='https://web.archive.org/web/20161027220953/http://esolog.uesp.net/resources/skill_divider.png' class='esovsSkillTooltipDivider' />";
...
function UpdateEsoSkillRawDataLink(skillId)
{
	...
	linkElement.attr("href", "https://web.archive.org/web/20161027220953/http://esoitem.uesp.net/viewlog.php?action=view&record=minedSkills&id=" + skillId);
}
...
/*
     FILE ARCHIVED ON 22:09:53 Oct 27, 2016 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 11.814
  LoadShardBlock: 372.545 (3)
  PetaboxLoader3.datanode: 270.781 (6)
  PetaboxLoader3.resolve: 161.368 (3)
  load_resource: 68.002
*/